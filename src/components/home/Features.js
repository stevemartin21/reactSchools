...
<section className="text-center my-5">
  ...
  <p className="lead grey-text w-responsive mx-auto mb-5">Lorem ipsum dolor sit amet, consectetur adipiscing elit,
  ...
  <div className="row">
    ...
    <div className="col-md-4">
      ...
      <i className="fa fa-comments fa-3x orange-text"></i>
